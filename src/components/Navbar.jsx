...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-20 transition-all duration-300 ease-in-out select-none ${isScrolled ? "bg-white shadow-sm-md py-6" : "bg-transparent py-6"
        }`}
    >
      <div
      ...
      >
        <a href="/" className="flex items-center flex-row">
          ...
          <span
            className={`text-2xl ml-1 mt-[2px] transition-all duration-300 ease-in-out ${isScrolled ? "font-bold text-[#B31942]" : "text-white font-semibold"
              }`}
          >
            Trescor
          </span>
