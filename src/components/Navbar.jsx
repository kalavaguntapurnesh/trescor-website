...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-20 transition-all duration-300 ease-in-out ${isScrolled ? "bg-white shadow-sm-md py-6" : "bg-transparent py-6"
        }`}
    >
      <div
        className={`max-w-[1400px] mx-auto flex justify-between items-center px-6  ${isScrolled ? "lg:py-0" : "lg:py-[12px]"
          }`}
      >
        <a href="/" className="flex items-center flex-row">
          ...
          <span
            className={`text-2xl ml-1 mt-[2px] transition-all duration-300 ease-in-out ${isScrolled ? "font-bold text-[#B31942]" : "text-white font-bold"
              }`}
          >
            Trescor
          </span>
        ...
        <div className="hidden lg:flex space-x-4">
          <a
            ...
            className={`border-[1px] relative  lg:px-6 md:px-4 py-2 rounded text-sm  transition duration-500 ${isScrolled
        ...
        <div className="lg:hidden">
          <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
            {isMobileMenuOpen ? (
              <AiOutlineClose
                className={`w-5 h-5 ${isScrolled ? "text-[#0A3161]" : "text-white"
                  }`}
              />
            ) : (
              <RiMenu3Fill
        ...
        >
          <a href="/" className="flex items-center  flex-row ml-4 pt-4 ">
            {/* <img src={HomeImg} alt="logo" className="md:w-8 md:h-8 h-6 w-6 " /> */}
            <span className="text-2xl text-[#B31942] ml-1 mt-[2px] transition-all duration-300 ease-in-out font-bold">
              Trescor
            </span>
          </a>
...
const Tab = ({ children, tab, handleSetSelected, selected }) => {
  ...
  return (
    <button
      ...
      className={`flex items-center gap-1 rounded-full md:text-sm lg:text-base px-3 py-1.5 transition-colors  ${isScrolled ? "text-[#0A3161]" : "text-white"
