...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div
        className={`max-w-[1400px] mx-auto flex justify-between items-center px-6  ${isScrolled ? "lg:py-0" : "lg:py-0"
          }`}
      >
        <a href="/" className="flex items-center flex-row">
          ...
          <span
            className={`text-2xl transition-all duration-300 ease-in-out ${isScrolled ? "font-bold text-[#B31942]" : "text-white font-bold"
              }`}
          >
            Trescor
          </span>
