...
const CalendarBooking = () => {
    ...
    return (
        <div className="p-4 w-[100%] bg-[#ffffff] ">
            ...
            <div className="flex flex-row shadow py-2.5 justify-between rounded-full items-center my-4 px-2">
                <button onClick={() => setActiveTab('calendar')} className={` rounded-full text-sm px-4 py-2 ${activeTab === 'calendar' ? "text-white bg-[#0A3161]" : "text-gray-600 bg-[#f2f2f3]"}`}>
                    Book a Discovery Call
                </button>

                <button onClick={() => setActiveTab('form')} className={` rounded-full text-sm px-4 py-2 ${activeTab === 'form' ? "text-white bg-[#0A3161]" : "text-gray-600 bg-[#f2f2f3]"}`}>
                    Fill a form with us
                </button>
            </div>
                ...
                <div>
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <div className="space-x-3">
                            <button onClick={() => handleMonthChange(-1)} className=" cursor-pointer text-gray-800 bg-white p-3 rounded-full shadow">
                                <FaAngleLeft />
                            </button>
                                    ...
                                    return (
                                        <div className="flex justify-center items-center">
                                            <button
                                                ...
                                                className={`rounded-full p-4 text-center ${!isAvailable || isPast
                                    ...
                                    <div className="grid lg:grid-cols-6 grid-cols-4  gap-2 mt-2">
                                        {availableSlots[selectedDate].map((slot, idx) => (
                                            <button
                                                ...
                                                className={`px-8 py-2.5 cursor-pointer text-sm rounded font-medium  ${slotTime === slot
