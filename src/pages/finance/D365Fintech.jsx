...
const D365Fintech = () => {
  const items = [
    {
      title: "Design a digital-first finance core",
      color: "#004B8D",
      points: [
        "Cloud-native finance backbone on Azure (entities, currencies, COA)",
        "Model fintech dimensions: wallet, card, BNPL, lending, partner, region",
      ],
    },
    {
      title: "Configure core finance & compliance",
      color: "#FF851B",
      points: [
        "GL, AP, AR, cash & bank and regulatory reporting",
        "Role-based access, approvals and full audit trail for SOX/IFRS/local regs",
      ],
    },
    {
      title: "Enable fintech-specific scenarios",
      color: "#2ECC40",
      points: [
        "Fee & interest recognition, multi-party settlement & reconciliation",
        "Chargebacks, refunds, disputes and fraud write-offs accounting",
      ],
    },
    {
      title: "Integrate, Automate & Monitor",
      color: "#0074D9",
      points: [
        "Connect to payment processors, wallets, card schemes and PSPs",
        "Power Platform + business events for automated settlements, alerts & approvals",
      ],
    },
  ];
  ...
  // SVG geometry (kept consistent with existing D365NeoBank sizing)
  const r = 160;
  const stroke = 120;
  ...
  const segments = [
    { id: 1, color: "#28A745", title: "Design digital-first finance core" },
    { id: 2, color: "#FFC107", title: "Configure core finance & compliance" },
    { id: 3, color: "#FF6B45", title: "Enable fintech scenarios" },
    { id: 4, color: "#00A3E8", title: "Integrate, Automate & Monitor" },
  ];
      ...
      <div className="lg:pt-20">
        <div className="w-full bg-white">
          ...
          <section className="relative w-full h-[650px] flex items-center justify-center overflow-hidden">
            <div
              className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1733503747506-773e56e4078f?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center"
              aria-hidden="true"
            />
            ...
            <div className="relative z-10 text-center px-4">
              <h1 className="mt-6 text-white tracking-wide text-3xl md:text-[40px] lg:text-[56px] leading-[1.02] font-extrabold">
                How We Implement Dynamics 365 Finance
                <br />
              ...
              <p className="mt-6 text-gray-200 text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
                A digital-first finance implementation for fintechs — built to
                model product economics, automate multi-party settlements and
          ...
          <section className="max-w-[1400px] mx-auto pt-12 pb-24 lg:block hidden">
            <div className="text-center mb-8">
              ...
              <p className="mt-3 text-slate-500 max-w-[760px] mx-auto">
                Phased delivery for fintechs: digital core, compliance, product
                accounting and connected automation.
              </p>
            </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h5 className="text-lg font-semibold text-[#073151]">
                          Design a digital-first finance core
                        </h5>
                        <ul className="mt-3 text-sm text-slate-700 space-y-1.5">
                          <li className="flex gap-2">
                            <FiCheckCircle className="text-[#7EB900] mt-1" />{" "}
                            Set up cloud-native finance backbone on Azure
                          </li>
                          <li className="flex gap-2">
                            <FiCheckCircle className="text-[#7EB900] mt-1" />{" "}
                            Model fintech dimensions: product, partner, region,
                            risk
                          </li>
                        </ul>
                      </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h5 className="text-lg font-semibold text-[#8a4a00]">
                          Configure core finance & compliance
                        </h5>
                        <ul className="mt-3 text-sm text-slate-700 space-y-1.5">
                          <li className="flex gap-2">
                            <FiCheckCircle className="text-[#FF9E3B] mt-1" />{" "}
                            GL, AP, AR, cash & bank, regulatory reporting
                          </li>
                          <li className="flex gap-2">
                            <FiCheckCircle className="text-[#FF9E3B] mt-1" />{" "}
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h5 className="text-lg font-semibold text-[#0a3d2b]">
                          Enable fintech-specific scenarios
                        </h5>
                        <ul className="mt-3 text-sm text-slate-700 space-y-1.5">
                          <li className="flex gap-2">
                            <FiCheckCircle className="text-[#7EB900] mt-1" />{" "}
                            Fee & interest revenue recognition, multi-party
                            settlement
                          </li>
                          <li className="flex gap-2">
                            <FiCheckCircle className="text-[#7EB900] mt-1" />{" "}
                            Structures for chargebacks, refunds, disputes &
                            fraud write-offs
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="mt-3 text-sm text-slate-700 space-y-1.5">
                          <li className="flex gap-2">
                            ...
                            Connect to payment processors, wallets, card schemes
                            & PSPs
                          </li>
                          <li className="flex gap-2">
                            <FiCheckCircle className="text-[#0074D9] mt-1" />{" "}
                            Power Platform + business events to automate
                            settlements, alerts & approvals
                          </li>
                        </ul>
                      </div>
                    </div>
          ...
          <section className="max-w-[1400px] mx-auto py-8 px-6">
            <div className="text-center mb-8">
              ...
              <p className="mt-3 text-slate-500 max-w-[760px] mx-auto">
                A practical approach to model unit economics, automate
                settlements and maintain compliance for high-velocity fintech
                products.
              </p>
            </div>
                    ...
                    <div className="grid lg:grid-cols-2 grid-cols-1 gap-10 items-center min-h-[500px]">
                      <div className="flex flex-col space-y-8 w-full justify-center h-full">
                        <div className="flex flex-col items-center lg:items-start text-center lg:text-left gap-2 px-2 md:px-0">
                          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight drop-shadow-md text-[#0A3161]">
                            Dynamics 365 Finance for Fintech
                            <br />
                            <span className="bg-gradient-to-r from-[#F14F21] via-[#00A3EE] to-[#7EB900] bg-clip-text text-transparent">
                              Unit Economics, Settlements & Compliance
                            </span>
                          </h1>
                        </div>
                        ...
                        <div className="text-gray-600 lg:text-lg text-base lg:text-start text-center lg:ml-2 px-2 md:px-0">
                          <p>
                            Dynamics 365 Finance lets fintechs unify product
                            accounting, manage multi-party settlements, automate
                            reconciliations and deliver auditable compliance
                            reporting — enabling rapid scale without sacrificing
                            control.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-center items-center w-full h-full min-h-[400px]">
                        <div className="relative flex justify-center items-center w-full h-full">
                          ...
                          <img
                            src="https://global.hitachi-solutions.com/wp-content/uploads/2024/02/Data_Analytics_Hero-Graphic.webp"
                            alt="Fintech Finance Solutions"
                  ...
                  <div className="md:flex md:h-[363px] mt-12">
                      ...
                      <div className="flex flex-col justify-center text-[#FFFFFF] gap-[20px] w-full">
                        <div className="flex flex-col gap-[8px]">
                          <p className="text-[24px] md:text-[28px] lg:text-[32px] font-bold whitespace-break-spaces">
                            Transform Your Fintech Finance & Ops with Dynamics
                            365
                          </p>
                          <h4 className="md:text-base text-sm w-auto md:max-w-[80%] whitespace-break-spaces">
                            Implement a digital-first finance core, automate
                            multi-party settlements, and monitor unit economics
                            with Power BI and connected integrations.
                          </h4>
                        </div>

                        <a href="/contact-trescor" className="w-fit px-[36px] py-[12px] rounded-full text-[14px] font-[500] bg-white text-black cursor-pointer">
                          Contact Us Now
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="hidden lg:block w-[100%] md:w-0 lg:w-[30%] h-[100%]">
                      <img
                        ...
                        alt="Fintech Transformation Banner"
                      />
                    </div>
                  </div>
                </div>
